use shadowquic::config::{
    default_alpn, default_congestion_control, default_initial_mtu, default_keep_alive_interval, default_min_mtu, default_over_stream, default_zero_rtt
};
    ...
    fn try_from(s: &OutboundShadowQuic) -> Result<Self, Self::Error> {
        Ok(Handler::new(
            ...
            HandlerOptions {
                ...
                keep_alive_interval: s.keep_alive_interval.unwrap_or(default_keep_alive_interval()),
            },
        ))
    }
}
